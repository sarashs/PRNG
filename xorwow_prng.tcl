...
#
# xorwow_prng.tcl: Tcl script for re-creating project 'xorwow_prng'
#
# Generated by Vivado on Tue Dec 07 04:35:23 -0800 2021
...
#
# 1. This project restoration tcl script (xorwow_prng.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/User/PRNG/xorwow_prng/xorwow_prng.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set _xil_proj_name_ "xorwow_prng"
...
set script_file "xorwow_prng.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/xorwow_prng"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../AppData/Roaming/Xilinx/Vivado/2020.1.1/xhub/board_store/xilinx_board_store"] [file normalize "$origin_dir/../AppData/Roaming/Xilinx/Vivado/2020.1/xhub/board_store/xilinx_board_store"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/xorwow_lite_1.0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/xorwow_prng/xorwow_prng.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  xilinx.com:user:xorwow_lite:1.0\
  "
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins xorwow_lite_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xorwow_lite_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xorwow_lite_0/s00_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xorwow_lite_0/S00_AXI/S00_AXI_reg] -force
